...
<body>
    <div class="container">
        ...
        <div class="controls">
            <button id="startBtn" onclick="startRecording()">🎙️ Start Talking</button>
            <button id="stopBtn" onclick="stopRecording()" class="stop-btn" disabled>⏹️ Stop</button>
        </div>
    ...
    <script>
        let ws, mediaRecorder, audioContext, analyser, microphone;
